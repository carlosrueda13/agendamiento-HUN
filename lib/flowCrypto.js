...
// Carga la llave privada (en base64 dentro de FLOW_PRIVATE_KEY_B64) y su passphrase.
function getPrivateKey() {
  const b64 = process.env.FLOW_PRIVATE_KEY_B64;
  if (!b64) throw new Error("FLOW_PRIVATE_KEY_B64 no está configurada");
  return Buffer.from(b64, "base64").toString("utf-8");
}

// Descifra la petición que envía Meta:
// 1) RSA-OAEP-SHA256 para recuperar la llave AES de sesión.
