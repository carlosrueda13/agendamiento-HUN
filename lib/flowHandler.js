...
async function pasoConfirmar(numero, version) {
  ...
  // El endpoint de asignación del HUN es lento (SOAP a Hosvital) y supera el
  // timeout del Flow de WhatsApp. Por eso respondemos de inmediato y hacemos la
  // asignación en segundo plano, confirmando luego por un mensaje de chat.
  asignarYConfirmar(numero, payload, elegido, sesion).catch((e) =>
  ...
  return {
    ...
    data: {
      ...
      detalle:
        ...
        `Te confirmaremos por este chat en unos segundos.`,
    },
  };
}
